                    ...
                    filteredLogs.map((log) => (
                      <TableRow key={log.id}>
                        <TableCell className="font-medium">
                          {format(new Date(log.createdAt), "MMM dd, yyyy HH:mm")} IST
                        </TableCell>
                        <TableCell>
                            ...
                            {log.action.startsWith('auto_logout') && log.details ? (
                              <div className="space-y-1">
                                ...
                                {log.details.timestamp && (
                                  <div>Time: {format(new Date(log.details.timestamp), "HH:mm:ss")} IST</div>
                                )}
                ...
                <TableBody>
                  {loginLogs.length === 0 ? (
                    ...
                    loginLogs.map((log) => (
                      <TableRow key={log.id}>
                        <TableCell className="font-medium">
                          {format(new Date(log.createdAt), "MMM dd, yyyy HH:mm:ss")} IST
                        </TableCell>
                        <TableCell>
                          <div className="flex items-center gap-2">
